...
export default function TelegramBot() {
    ...
    return (
        <div style={{
            ...
            {/* Three-panel chat layout — fills all remaining space, NEVER scrolls */}
            <div style={{ flex: 1, display: 'flex', overflow: 'hidden', paddingBottom: '24px', paddingTop: '24px', gap: '24px', minHeight: 0 }}>
                {/* Sidebar de Chats */}
                <div className="glass-panel" style={{ width: '280px', display: 'flex', flexDirection: 'column', borderRadius: '20px', overflow: 'hidden', flexShrink: 0 }}>
                    <div style={{ padding: '20px', borderBottom: '1px solid rgba(0,0,0,0.05)' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '16px' }}>
                            ...
                            <h2 style={{ fontSize: '16px', fontWeight: 700, margin: 0, color: 'var(--text-primary)' }}>Chats Activos</h2>
                    ...
                    {selectedChat ? (
                        <>
                            ...
                            <div
                                ...
                                style={{ flex: 1, overflowY: 'auto', padding: '20px 24px', display: 'flex', flexDirection: 'column', gap: '12px', background: 'rgba(0,0,0,0.015)' }}
                            >
                                {messages.length === 0 && (
